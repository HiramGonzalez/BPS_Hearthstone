...
struct SearchResultsView: View {
    ...
    init(searchTerm: String) {
        ...
        _viewModel = ObservedObject(wrappedValue: SearchResultsView.ViewModel(searchTerms: searchTerm.replacingOccurrences(of: " ", with: "%20")))
    }
}

struct SearchResultsView_Previews: PreviewProvider {
    static var previews: some View {
        SearchResultsView(searchTerm: "Driud")
    }
}
